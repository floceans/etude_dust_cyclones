...
with open(output_filename, 'w', encoding='utf-8') as outfile:
    for year in range(start_year, end_year + 1):
        ...
        filename = f"/home/florent/Documents/CNRM/git/etude_dust_cyclones/trajectoires_1/fichiers_traj/suiERA5_evaluation_{year}-{year+1}.vor5_res17_1_-2_5.{suffix}.csv"
