...
if len(sys.argv) < 3:
    print("Usage: python track_density_ibtracs.py <year_min> <year_max>")
    sys.exit(1)

year_min = int(sys.argv[1]) if len(sys.argv) > 1 else 2010
year_max = int(sys.argv[2]) if len(sys.argv) > 2 else 2020

file_path = '/home/florent/Documents/CNRM/git/etude_dust_cyclones/densite/ibtracs.NA.list.v04r01_1960-2024.csv'
output_dir = 'images'
