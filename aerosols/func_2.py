...
def plot_aod_map(da, title="AOD Moyenne"):
...
def plot_time_series(da, filename):
    ...
    plt.title("Série temporelle AOD (Moyenne zone Atlantique)", fontweight='bold')
    plt.grid(True, alpha=0.3)
    plt.tight_layout()

def plot_histogram(da):
    ...
    plt.title("Distribution de l'AOD", fontweight='bold')
    plt.yscale('log')
    plt.tight_layout()