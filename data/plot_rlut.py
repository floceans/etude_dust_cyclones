...
file_ref = "/cnrm/mosca/USERS/puyf/stage/data/rlut/rlut_concat_ref_3weeks_monthly_1960-2000.nc"
file_exp = "/cnrm/mosca/USERS/puyf/stage/data/rlut/rlut_concat_NoRadDust_3weeks_monthly_1960-2000.nc"
...
# --- Calcul des données ---
print(f"Calcul des moyennes RLUT pour la période {YEAR_MIN}-{YEAR_MAX}...")
...
for i, ax in enumerate(axes):
    ...
    if i < 2:
        ...
        cbar_label = "Différence RLUT (W/m²)"
