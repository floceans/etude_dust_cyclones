...
if __name__ == "__main__":
    ...
    aod_data_merra_dust = load_data('/home/puyf/Documents/dust_brut_1/merra/AOT_MERRA2_198001-202012.nc', "DUEXTTAU", an_min,an_max, JJASO=True)
    aod_data_merra_dust_mdr = load_data('/home/puyf/Documents/dust_brut_1/merra/AOT_MERRA2_MDR_198001-202012.nc', "DUEXTTAU", an_min,an_max, JJASO=True)
    aod_data_merra_aer = load_data('/home/puyf/Documents/dust_brut_1/merra/AOT_MERRA2_198001-202012.nc', "TOTEXTTAU", an_min,an_max, JJASO=True)
    aod_data_modis = load_data('/home/puyf/Documents/dust_brut_1/modis/AOD_550_Dark_Target_Deep_Blue_Combined_Mean_Mean_200207-202312.nc', None, an_min,an_max,JJASO=True)
    aod_data_aladin_aer = load_data('/home/puyf/Documents/dust_brut_1/aladin/aladin_aer_mensuel_1960-2024.nc', "od550aer", an_min,an_max,JJASO=True)
    aod_data_aladin_dust_4s = load_data('/home/puyf/Documents/dust_brut_1/aladin/aladin_dust_mensuel_1960-2024.nc', 'od550dust', an_min,an_max,JJASO=True)
    aod_data_aladin_dust_3s = load_data('/home/puyf/Documents/dust_brut_1/aladin/aladin_dust_mensuel_3weeks_1960_2024.nc', 'od550dust', an_min,an_max,JJASO=True)
    aod_data_aladin_dust_3s_mdr = load_data('/home/puyf/Documents/dust_brut_1/aladin/aladin_dust_MDR_mensuel_3weeks_1960_2024.nc', 'od550dust', an_min,an_max,JJASO=True)
    aod_data_aladin_dust_4s_mdr = load_data('/home/puyf/Documents/dust_brut_1/aladin/aladin_dust_mensuel_MDR_1960-2024.nc', 'od550dust', an_min,an_max,JJASO=True)
    ...
    """    fig_diff = plot_aod_diff_map( 
        ...
        "ALADIN Dust 3s", 
        "MERRA-Dust", 
        vlimit=0.15  # Ajuste selon l'intensité de la différence
    )
    """
    ...
    dict_clim_dust_mdr = {
            ...
            "ALADIN Dust MDR 3s": aod_data_aladin_dust_3s_mdr
        }
