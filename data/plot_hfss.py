...
file_ref = "/cnrm/mosca/USERS/puyf/stage/data/hf/hfss_concat_ref_3weeks_monthly_1960-2000.nc"
file_exp = "/cnrm/mosca/USERS/puyf/stage/data/hf/hfss_concat_norad_3weeks_monthly_1960-2000.nc"
...
# --- Calcul des données ---
print(f"Calcul des moyennes hfss pour la période {YEAR_MIN}-{YEAR_MAX}...")
...
iso_levels_diff = np.arange(-diff_limit, diff_limit + 1, 5) # Une ligne tous les 2 W/m²

titles = [f"NoRadDust - {YEAR_MIN}-{YEAR_MAX}", 
          f"Reférence - {YEAR_MIN}-{YEAR_MAX}", 
          "Différence (NoRadDust - Ref)"]

data_to_plot = [mean_exp, mean_ref, diff_rsds] 
...
for i, ax in enumerate(axes):
    ...
    if i < 2:
        ...
        cbar_label = "Différence hfss (W/m²)"
